...
import satyanarayana from '../images/pooja/kit4.jpg'
function Sathyanarayanapooja() {
  return (
    <div>
    <div className='pooja-page-container'>
      <div className='pooja-subpage-container'>
        <div className='pooja-sub-banner'>
          <img src={satyanarayana} className='pooja-subpage-img' />
        </div>
        <div id='pooja-banner-content'>
          <h2> SATYANARAYANA POOJA</h2>
          <p>The puja is described in the Skanda Purana, a medieval era Sanskrit text. According to Madhuri Yadlapati, the Satyanarayana Puja is an archetypal example of how "the Hindu puja facilitates the intimacy of devotional worship while enabling a humble sense of participating gratefully in a larger sacred world". The puja narrates the Satyanarayana Katha (story), which dictates the various worldly and spiritual benefits the puja brings to performers. The Katha states how the deity Narayana vows to aid his devotees during Kali Yuga, the last of the four ages in Hindu cosmology, in particular the performers and attendees of the Satyanarayana Puja.     </p>
        </div>
      </div>
      </div>
...
export default Sathyanarayanapooja;
