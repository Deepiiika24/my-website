...
First start with supari | paaku. And then with other ingredients and lastly with gulkand.Close the cone and keep a cherry in the middle and insert a tooth pick in the middle.</p>
      ...
      <section className='beeda-product'>
        ...
        <div className='card'>
              ...
              <h3 className='link1-namebeeda'><Link to='/Shreddedcoconut'>Shredded Coconut</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg2} className='beeda-pic'></img>
              <h3 className='link2-namebeeda'><Link to='/Sweetjeeramittai'>Sweet Jeera Mittai</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg3} className='beeda-pic'></img>
              <h3 className='link3-namebeeda'><Link to='/Rosegulkand'>Rose Gulkand</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg5} className='beeda-pic'></img>
              <h3 className='link5-namebeeda'><Link to='/Drytuttifrutti'>Dry Tutti Frutti</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg6} className='beeda-pic'></img>
              <h3 className='link6-namebeeda'><Link to='/Dryclove'>Dry Clove</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg7} className='beeda-pic'></img>
              <h3 className='link7-namebeeda'><Link to='/Sweetpanchutni'>Sweet Pan Chutni</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg8} className='beeda-pic'></img>
              <h3 className='link8-namebeeda'><Link to='/Cardamomseeds'>Cardamom Seeds</Link> </h3>
             </div>
             <div className='card'>
                 <img src={veg9} className='beeda-pic'></img>
              <h3 className='link9-namebeeda'><Link to='/Kanpuribiscuit'>Kanpuri Biscuit</Link> </h3>
             </div>
