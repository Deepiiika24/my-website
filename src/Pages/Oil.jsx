      ...
      <div className="rice-container">
        ...
        <div className="rice-sub-container">
          <div className='card'>
            ...
            <h3 className='rice-link1-name' id='rice-link-name'><Link to='/RiceBasmatirice'>Peanut Oil</Link> </h3>
          </div>
          <div className='card'>
            <img src={rice2} className='rice-pic'></img>
            <h3 className='rice-link1-name' id='rice-link-name'><Link to='/RiceMattarice'>Ghee</Link> </h3>
          </div>
          <div className='card'>
            <img src={rice3} className='rice-pic'></img>
            <h3 className='rice-link1-name' id='rice-link-name'><Link to='/RiceIdlirice'>Palm oil</Link> </h3>
          </div>
          <div className='card'>
            <img src={rice4} className='rice-pic'></img>
            <h3 className='rice-link1-name' id='rice-link-name'><Link to='/RiceBoiledrice'>Sun flower Oil</Link> </h3>
          </div>
          <div className='card'>
            <img src={rice5} className='rice-pic'></img>
            <h3 className='rice-link1-name' id='rice-link-name'><Link to='/RiceRedrice'>Sesame Oil</Link> </h3>
          </div>
          <div className='card'>
            <img src={rice6} className='rice-pic'></img>
            <h3 className='rice-link1-name' id='rice-link-name'><Link to='/RiceSeeraghasamba'>Coconut Oil</Link> </h3>
          </div>
        </div>
      </div>
    </div>
