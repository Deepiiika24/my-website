            ...
            <section className='footer'>
                <div className='container'>
                    ...
                    <div className='footer-content'>
                        ...
                        <ul>
                            ...
                            <li><Link to="/aboutus"><ArrowForwardIosIcon/>Aboutus</Link></li>
                             <li><ArrowForwardIosIcon/>Products</li>
                            <li><Link to="/contactus"><ArrowForwardIosIcon/>Contactus</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className='footer-content'>
                      ...
                      <li><Link to="/Poojaproduct"><ArrowForwardIosIcon/>Vegetables</Link></li>
                      <li><Link to="/Rice"><ArrowForwardIosIcon/>Rice</Link></li>
                      <li><Link to="/Spices"><ArrowForwardIosIcon/>Spices</Link></li>
                      <li><Link to="/Poojaproduct"><ArrowForwardIosIcon/>Poojaproduct</Link></li>
                ...
                <span ><FontAwesomeIcon icon={faInstagram} /></span>
                    ...
                    <div className='footer-content'>
                        <h4>Branches</h4>
                        <ul>
                            <li > <ArrowForwardIosIcon/>TamilNadu, India</li>
                            <li><ArrowForwardIosIcon/> Melbourl, Australia</li>
                        </ul>
                    </div>
                    <div className='footer-content'>
